...
<body class="main-layout">
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="logo">
                        <a href="index.html"><img src="images/sijago-logo-removebg-preview.png" class="img-fluid w-50 h-50" style="margin-top: -50px" alt="#" /></a>
                     </div>
                  </div>
               </div>
                  ...
                  <nav class="navigation navbar navbar-expand-md navbar-dark  ">
                     ...
                     <div class="collapse navbar-collapse" id="navbarsExample04">
                        <ul class="navbar-nav mr-auto">
                           ...
                           <li class="nav-item ">
                              <a class="nav-link btn btn-outline-danger  mx-3 rounded-pill" style="padding: 10px 20px;" href="login.php">Login</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn btn-outline-success  rounded-pill" style="padding: 10px 20px;" href="register.php">Sign Up</a>
                           </li>
   ...
   <!-- end header -->
   <!-- Our  Glasses section -->
   <div class="glasses" style="padding: 100px;">
      <div class="container">
         <div class="row">
